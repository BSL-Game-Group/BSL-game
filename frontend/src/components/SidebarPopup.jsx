  ...
  return (
    <div className="popup-overlay">
      <div
        className="popup-box"
        style={{
          width: '88%', maxWidth: '620px', minHeight: '320px', gap: '20px',
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <h2 style={{ margin: 0, color: '#000' }}>Lecture Materials</h2>
          <p style={{ margin: 0, color: '#000', fontSize: '1rem' }}>
            Click a link below to open the lecture material in a new tab.
          </p>
